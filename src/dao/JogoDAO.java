...
public class JogoDAO {
     ...
     public List<Jogo> jogoPorPlataforma(String plataforma){
     ...
     public List<Jogo> jogoEPlataformaPorGenero(String genero){
          
          List<Jogo> jogos = new ArrayList<>();
          
          try {
               PreparedStatement stmt = connection.prepareStatement("SELECT J.NOME_JOGO, P.NOME_PLATAFORMA" +
                         " FROM JOGO J INNER JOIN PLATAFORMA P" +
                         " ON J.ID_PLATAFORMA = P.ID_PLATAFORMA INNER JOIN GENEROS G" +
                         " ON G.ID_GENERO = J.ID_GENERO" +
                         " WHERE G.NOME_GENERO = '"+genero+"'");
               ResultSet rs = stmt.executeQuery();
